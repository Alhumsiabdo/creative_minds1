    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="{{ asset('assets/uploads/hero.png')}}" class="header-brand-img mobile-icon" alt="logo">
                <img src="{{ asset('assets/uploads/hero.png')}}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
